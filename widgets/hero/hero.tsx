    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-[#F4F7FB] via-white to-[#E8EFF8] py-8 md:py-12">
      ...
      <div className="container relative">
        ...
        <motion.div
          ...
          className="mx-auto max-w-3xl text-center pt-4"
        >
          ...
          <p className="mt-6 text-lg md:text-xl text-[#3A5070] leading-relaxed">
        ...
        >
          {[
            ...
            <motion.div
              ...
              className="min-w-0 flex h-full flex-col gap-2 rounded-2xl border border-gray-100 bg-white p-4 shadow-sm"
            >
