...
import { ref } from 'vue';
import { Glasses, Globe, User, ChevronDown, Phone, Mail } from "lucide-vue-next";
  ...
  <div class="border-b border-[#0050AA]/10 bg-[#F4F7FB]">
    <div class="container">
      <div class="flex min-h-10 items-center justify-between gap-4 py-2 text-xs text-[#3A5070]">
        ...
        <div class="grid w-full grid-cols-2 items-center gap-x-4 gap-y-2 sm:grid-cols-3 sm:gap-8 xl:w-auto">
          <a href="tel:+78432220557" class="group flex items-center gap-2 min-w-0">
            <div class="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-white shadow-sm group-hover:bg-[#0050AA] group-hover:text-white transition-all text-[#0050AA]">
            ...
            <div class="min-w-0">
              ...
              <span class="hidden text-[9px] leading-tight text-[#7A96B4] sm:block">Контакт-центр</span>
            </div>
          </a>
          <a href="mailto:CZN_g_Kazan@tatar.ru" class="group flex items-center gap-2 min-w-0 sm:col-span-1">
            <div class="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-white shadow-sm group-hover:bg-[#0050AA] group-hover:text-white transition-all text-[#0050AA]">
            ...
            <div class="min-w-0">
              ...
              <span class="hidden text-[9px] leading-tight text-[#7A96B4] sm:block">Электронная почта</span>
            </div>
          </a>
          <a href="tel:+78435641111" class="group flex items-center gap-2 col-span-2 min-w-0 sm:col-span-1">
            <div class="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-white shadow-sm group-hover:bg-[#0050AA] group-hover:text-white transition-all text-[#0050AA]">
              <Phone class="h-3.5 w-3.5" />
            </div>
            <div class="min-w-0">
              ...
              <span class="hidden text-[9px] leading-tight text-[#7A96B4] sm:block">Горячая линия СВО</span>
            </div>
          </a>
        </div>
